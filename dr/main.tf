...
module "bastion" {
  ...
  source                               = "/landing_zone/dr/bastion"
...
########################################## BUCKET ##########################################
module "bucket" {
  source              = "/landing_zone/dr/buckets"
...
module "service_gateway" {
  source                       = "/landing_zone/dr/service_gateway"
...
module "internet_gateway" {
  source                        = "/landing_zone/dr/internet_gateway"
...
########################################## NAT GATEWAY ##########################################
module "nat_gateway" {
  source                   = "/landing_zone/dr/nat_gateway"
...
module "security_list" {
  source                     = "/landing_zone/dr/security_list"
...
########################################## ROUTE TABLE ##########################################
module "route_table" {
  source                   = "/landing_zone/dr/route_table"
...
########################################## DRG ##########################################
module "drg" {
  source         = "/landing_zone/dr/drg/drg"
...
module "drg_attachment" {
  source                              = "/landing_zone/dr/drg/drg_attachment"
...
module "drg_route_distribution" {
  source            = "/landing_zone/dr/drg/drg_route_distribution"
...
module "drg_route_distribution_statement" {
  source                    = "/landing_zone/dr/drg/drg_route_distribution_statement"
...
module "drg_route_table" {
  source                    = "/landing_zone/dr/drg/drg_route_table"
...
module "vss_host_scan_recipe" {
  source                                                     = "/landing_zone/dr/vss/vss_host_scan_recipe"
...
module "vss_host_scan_target" {
  source                   = "/landing_zone/dr/vss/vss_host_scan_target"
